...
void registerPub(ros::NodeHandle &n)
{
    ...
    pub_camera_pose = n.advertise<geometry_msgs::TransformStamped>("camera_pose", 1000);
...
void pubCameraPose(const Estimator &estimator, const std_msgs::Header &header)
{
    ...
    if (estimator.solver_flag == Estimator::SolverFlag::NON_LINEAR)
    {
        ...
        odometry.transform.translation.x = P.x();
        odometry.transform.translation.y = P.y();
        odometry.transform.translation.z = P.z();
        odometry.transform.rotation.x = R.x();
        odometry.transform.rotation.y = R.y();
        odometry.transform.rotation.z = R.z();
        odometry.transform.rotation.w = R.w();
