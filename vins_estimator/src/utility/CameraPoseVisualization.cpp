...
const Eigen::Vector3d CameraPoseVisualization::imlt_airsim = Eigen::Vector3d(-1.0, 1.0, 0.5);
const Eigen::Vector3d CameraPoseVisualization::imrt_airsim = Eigen::Vector3d(1.0, 1.0, 0.5);
const Eigen::Vector3d CameraPoseVisualization::imlb_airsim = Eigen::Vector3d(-1.0, 1.0, -0.5);
const Eigen::Vector3d CameraPoseVisualization::imrb_airsim = Eigen::Vector3d(1.0, 1.0, -0.5);
const Eigen::Vector3d CameraPoseVisualization::lt0_airsim = Eigen::Vector3d(-0.7, 1.0, 0.5);
const Eigen::Vector3d CameraPoseVisualization::lt1_airsim = Eigen::Vector3d(-0.7, 1.0, 0.2);
const Eigen::Vector3d CameraPoseVisualization::lt2_airsim = Eigen::Vector3d(-1.0, 1.0, 0.2);
const Eigen::Vector3d CameraPoseVisualization::oc_airsim = Eigen::Vector3d(0.0, 1.0, 0.0);

// const Eigen::Matrix3d CameraPoseVisualization::R_airsim_normal = (Eigen::Matrix3d() << 1, 0, 0,
...
void CameraPoseVisualization::add_pose(const Eigen::Vector3d &p, const Eigen::Quaterniond &q) {
  ...
  if (IS_AIRSIM) {
    Eigen2Point(q * (m_scale * imlt_airsim) + p, pt_lt);
    Eigen2Point(q * (m_scale * imlb_airsim) + p, pt_lb);
    Eigen2Point(q * (m_scale * imrt_airsim) + p, pt_rt);
    Eigen2Point(q * (m_scale * imrb_airsim) + p, pt_rb);
    Eigen2Point(q * (m_scale * lt0_airsim) + p, pt_lt0);
    Eigen2Point(q * (m_scale * lt1_airsim) + p, pt_lt1);
    Eigen2Point(q * (m_scale * lt2_airsim) + p, pt_lt2);
    Eigen2Point(q * (m_scale * oc_airsim) + p, pt_oc);
  } else {
