...
public:
   ...
   */
  inline void operator()(const cv::Mat &image, const std::vector<cv::KeyPoint> &points,
   ...
   */
  inline void exportPairs(std::vector<int> &x1, std::vector<int> &y1, std::vector<int> &x2,
   ...
   * @param y2 y2 coordinates of pairs
   */
  inline void importPairs(const std::vector<int> &x1, const std::vector<int> &y1,
